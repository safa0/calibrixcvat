...
// ROI Constants
const ROI_STROKE_WIDTH = 2;
const ROI_SELECTED_STROKE_WIDTH = 3;
const ROI_FEATURE_POINT_RADIUS = 3;
const ROI_TEMPLATE_OPACITY = 0.7;
const ROI_MATCHING_RESULT_OPACITY = 0.8;
const ROI_DEFAULT_COLOR = '#00ff00';
const ROI_SELECTED_COLOR = '#ff0000';
const ROI_FEATURE_POINT_COLOR = '#ffff00';
const ROI_CONFIDENCE_THRESHOLD = 0.7;
...
export default {
    ...
    SHADED_COLOR,
    ROI_STROKE_WIDTH,
    ROI_SELECTED_STROKE_WIDTH,
    ROI_FEATURE_POINT_RADIUS,
    ROI_TEMPLATE_OPACITY,
    ROI_MATCHING_RESULT_OPACITY,
    ROI_DEFAULT_COLOR,
    ROI_SELECTED_COLOR,
    ROI_FEATURE_POINT_COLOR,
